...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <style>
   .mp_writing .mainDown td:nth-child(3){
      width: 283px;
   }
   .mp_writing .mainDown td:nth-child(4){
      width: 274.5px;
   }
    </style>
<%
...
<%
   ...
   bbqBoardVO bbean = bdao.getThisBoardList(num);
        ...
        <form action="updateBoardCtrl.jsp" method="post">
           <table class="table cf">
                ...
                <tr>
                    <th>매장명</th>
                    <td>
                        <input type="text" id="branch_name" name="store" value="<%=bbean.getStore() %>" readonly>
                    </td>
                </tr>
                <tr>
                    <th>분류</th>
                    <td>
                        ...
                        <select name="type" class="voc_select" id="selectBox">
                ...
                <tr>
                    <th>작성자</th>
                    <td>
                        <input type="text" name="writer" value="<%=bbean.getWriter() %>" class="voc_customerName" readonly>
                    </td>
                </tr>
                <tr>
                    <th>연락처</th>
                    <td>
                        <input type="text" name="contact" value="<%=bbean.getContact() %>" class="voc_customerNumber" readonly>
                    </td>
                </tr>
                <tr>
                    <th>작성일</th>
                ...
                <tr>
                    <th>글제목</th>
                    <td>
                        <input type="text" name="title" class="voc_textTitle" value="<%=bbean.getTitle() %>">
                    </td>
                </tr>
                <tr>
                    <th>파일첨부</th>
                ...
                <tr>
                        <th>내용</th>
                        <td>
                            <textarea name="content" class="voc_textarea" cols="40" rows="10" ><%=bbean.getContent() %></textarea>
                        </td>
                    </tr>
            </table>
           <div class="voc_btn">
...
<script>
    $("#selectBox").val("<%=bbean.getType() %>").prop("selected, true");
